...
export const FundManagementDocumentDropZone = (T) => class FundManagementDocumentDropZone extends T {
    setup() {
        super.setup();
...
export const FundManagementDocumentUpload = (T) => class FundManagementDocumentUpload extends T {
    setup() {
        super.setup();
    ...
    async onUpload(attachments) {
        ...
        const action = await this.orm.call('fund.management', 'create_fund_management_from_attachments', ["", attachmentIds]);
