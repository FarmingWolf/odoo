...
def compute_company_statistics(latest_property_details):
    ...
    return {
        ...
        'pie_chart_ratio_property_area_quantity': {
            '在租(㎡)': round(estate_property_area_lease_quantity, 2),
            '空置(㎡)': round(estate_property_area_quantity - estate_property_area_lease_quantity, 2),
        },
        'latest_property_detail': latest_property_details,
        ...
        'pie_chart_ratio_conventional_area_quantity': {
            '在租(㎡)': round(conventional_area_on_rent, 2),
            '空置(㎡)': round(conventional_area - conventional_area_on_rent, 2),
        },
        ...
        'pie_chart_ratio_unconventional_area_quantity': {
            '在租(㎡)': round(estate_property_area_lease_quantity - conventional_area_on_rent, 2),
            '空置(㎡)':
        ...
        'fee_electricity_maintenance_receivable_month_next': round(fee_electricity_maintenance_receivable_month_next,
                                                                   2),
        'fee_electricity_maintenance_receivable_quarter_next': round(
            fee_electricity_maintenance_receivable_quarter_next, 2),
...
class EstateDashboardService:
    ...
    def get_statistics_svc(company_id, env):
        ...
        return compute_company_statistics(latest_property_detail)
