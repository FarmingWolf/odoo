...
class SMSAliyun(http.Controller):
    ...
    def create_client() -> Dysmsapi20170525Client:
        ...
        @throws Exception
        """
        ALIBABA_CLOUD_ACCESS_KEY_ID = request.env['ir.config_parameter'].sudo().get_param('ALIBABA_CLOUD_ACCESS_KEY_ID')
        if not ALIBABA_CLOUD_ACCESS_KEY_ID:
            ALIBABA_CLOUD_ACCESS_KEY_ID = os.environ['ALIBABA_CLOUD_ACCESS_KEY_ID']

        ALIBABA_CLOUD_ACCESS_KEY_SECRET = request.env['ir.config_parameter'].sudo().get_param('ALIBABA_CLOUD_ACCESS_KEY_SECRET')
