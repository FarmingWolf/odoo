...
class WebsiteSnippetFilter(models.Model):
    ...
    def _get_hardcoded_sample(self, model):
        ...
        if model._name == 'event.event':
            data = [{
                'cover_properties': '{"background-image": "url(\'/website_event/static/src/img/event_cover_491.jpg\')", "resize_class": "o_record_has_cover o_half_screen_height", "opacity": "0.4"}',
