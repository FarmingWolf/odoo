...
class EastateLeaseContractApprovalDetail(models.Model):
    _name = "estate.lease.contract.approval.detail"
    _description = "资产租赁合同审批明细"
    _order = "id DESC"

    contract_id = fields.Many2one('estate.lease.contract', string="资产租赁合同", ondelete="restrict")  # 拒绝删除
    ...
    approval_stage = fields.Many2one('estate.lease.contract.approval.stage', string="审批阶段",
