...

{
    ...
    'data': [
        ...
        'views/estate_lease_contract_property_fee_maintenance_views.xml',
        'views/estate_lease_contract_property_fee_water_views.xml',
        'views/estate_lease_contract_property_fee_electricity_views.xml',
        'views/estate_lease_contract_property_fee_electricity_maintenance_views.xml',
        'views/estate_lease_contract_property_deposit_views.xml',
        'views/estate_lease_contract_property_tax_views.xml',
        'views/estate_lease_contract_turnover_amt_received_views.xml',
        'views/estate_lease_contract_management_fee_period_percentage_views.xml',
        'views/estate_lease_contract_property_manage_fee_detail_views.xml',
